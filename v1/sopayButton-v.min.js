const scripts=document.getElementById("SBScript"),language=scripts.getAttribute("data-lang"),fr={momo:{title:"Confirmez !",content:"Confirmez votre transaction mobile money en tapant *126#"},eu:{title:"Confirmez !",content:"Confirmez votre transaction Express Union sur votre application mobile EU app"},bitcoin:{title:"Proc\xE9dez \xE0 la transaction",content:"Vous pouvez transf\xE9rer sur ce portefeuille",total:"Montant \xE0 transferez :"},om:{title:"Confirmez !",content:"Confirmez votre transaction mobile money en tapant #150*50#"}},en={momo:{title:"Confirm !",content:"Confirm your mobile money's transaction by typing *126#"},eu:{title:"Confirm !",content:"Confirm your Express Union transaction on your mobile app EU"},bitcoin:{title:"Proceed To Transaction",content:"Please make transfert on this wallet",total:"Amount to transfert :"},om:{title:"Confirm !",content:"Confirm your orange money's transaction by typing #150*50#"}},lang="fr"==language.toLowerCase()?fr:en;function tip({elem:a,onSuccess:b,onFail:c,successUrl:d,currency:e,description:f,businessName:g,ref:h}){const i=$(`${a}_amount`).val(),j=$(`${a}_wallet`).val(),k=$(`${a}_service`).val();let l=$("#payer_name").val();const m=$(`${a}_otp`).val(),n=document.getElementById("SBScript"),o=n.getAttribute("data-apikey"),p="https://soleaspay.com/api/agent/bills?from=SELF";""==l&&(l="Client Divert");const q=a=>{const b={pageSize:{width:80,height:"auto"},defaultStyle:{fontSize:3,alignment:"center"},content:[{columns:[{width:"auto",text:"Receipt No: "+a.data.payId},{width:"*",text:g}],columnGap:15,margin:[0,0,0,5]},{columns:[{width:"auto",text:"Payer: "+l},{width:"*",text:`Payment Date: ${new Date().toDateString()}`}],columnGap:10,margin:[0,0,0,5]},{layout:"lightHorizontalLines",table:{headerRows:1,widths:["*","auto","*"],body:[["Ref","Description","Price"],[`${a.data.payId}`,`${f}`,a.data.amount],["",{text:"Total",bold:!0},{text:`${a.data.amount}`+" "+e,bold:!0}]]}},{text:"Created by https://soleaspay.com",margin:[0,10,0,0]}],pageOrientation:"portrait",pageMargins:[2,10]};pdfMake.createPdf(b).print()};switch(a){case"#om":$("#loader").show(),$.alert({title:lang.om.title,content:lang.om.content}),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`,otp:`${m}`},data:JSON.stringify({amount:i,wallet:j,currency:e,description:f,payer:l,ref:h})}).done(function(a){a.success?(q(a),b(a),$("#modalBtnClose").click()):c(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#momo":$("#loader").show(),$.alert({title:lang.momo.title,content:lang.momo.content}),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`,otp:`${m}`},data:JSON.stringify({amount:i,wallet:j,currency:e,description:f,payer:l,ref:h})}).done(function(a){a.success?(q(a),b(a),$("#modalBtnClose").click()):c(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#eu":$("#loader").show(),$.alert({title:lang.eu.title,content:lang.eu.content}),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`,otp:`${m}`},data:JSON.stringify({amount:i,wallet:j,currency:e,description:f,payer:l,ref:h})}).done(function(a){a.success?(q(a),b(a),$("#modalBtnClose").click()):c(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#bitcoin":$("#loader").show(),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`},data:JSON.stringify({amount:i,currency:e,description:f,payer:l,ref:h})}).done(function(a){a.success?($.alert({title:lang.bitcoin.title,content:`${lang.bitcoin.title}. <br>
                                        ...
                                        <input type="text" value="${a.data.wallet}" disabled id="myInput">
                                           ...
                                           <br> ${lang.bitcoin.total} : <b>${a.data.value} ${a.data.currency}</b>`}),b(a)):c(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#paypal":$("#loader").show(),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`},data:JSON.stringify({amount:i,wallet:j,currency:e,description:f,payer:l,ref:h})}).done(function(a){a.success?(window.open(`${a.data.payLink}`,"newwindow","width=900, height=800"),b(a)):c(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#pm":$("#loader").show(),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`},data:JSON.stringify({amount:i,currency:e,description:f,payer:l,ref:h})}).done(function(a){a.success?(window.open(`https://soleaspay.com/pm/pay.html?amount=${i}&ref=${a.data.payId}&currency=${e}&successUrl=${d}`,"newwindow","width=900, height=800"),b(a)):c(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;default:}}function bill({elem:a,amount:b,onSuccess:c,onFail:d,successUrl:e,currency:f,description:g,businessName:h,ref:i}){const j=$(`${a}_wallet`).val(),k=$(`${a}_service`).val(),l=$(`${a}_otp`).val();let m=$("#payer_name").val();const n=document.getElementById("SBScript"),o=n.getAttribute("data-apikey"),p="https://soleaspay.com/api/agent/bills?from=SELF";""==m&&(m="Client Divert");const q=a=>{const b={pageSize:{width:80,height:"auto"},defaultStyle:{fontSize:3,alignment:"center"},content:[{columns:[{width:"auto",text:"Receipt No: "+a.data.payId},{width:"*",text:h}],columnGap:15,margin:[0,0,0,5]},{columns:[{width:"auto",text:"Payer: "+m},{width:"*",text:`Payment Date: ${new Date().toDateString()}`}],columnGap:10,margin:[0,0,0,5]},{layout:"lightHorizontalLines",table:{headerRows:1,widths:["*","auto","*"],body:[["Ref","Description","Price"],[`${a.data.payId}`,`${g}`,a.data.amount],["",{text:"Total",bold:!0},{text:`${a.data.amount}`+" "+f,bold:!0}]]}},{text:"Created by https://soleaspay.com",margin:[0,10,0,0]}],pageOrientation:"portrait",pageMargins:[2,10]};pdfMake.createPdf(b).print()};switch(a){case"#om":$("#loader").show(),$.alert({title:lang.om.title,content:lang.om.content}),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`,otp:`${l}`},data:JSON.stringify({amount:b,wallet:j,currency:f,description:g,payer:m,ref:i})}).done(function(a){a.success?(q(a),c(a),$("#modalBtnClose").click()):d(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#momo":$("#loader").show(),$.alert({title:lang.momo.title,content:lang.momo.content}),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`,otp:`${l}`},data:JSON.stringify({amount:b,wallet:j,currency:f,description:g,payer:m,ref:i})}).done(function(a){a.success?(q(a),c(a),$("#modalBtnClose").click()):(d(a),$(".close").click())}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#eu":$("#loader").show(),$.alert({title:lang.eu.title,content:lang.eu.content}),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`,otp:`${l}`},data:JSON.stringify({amount:b,wallet:j,currency:f,description:g,payer:m,ref:i})}).done(function(a){a.success?(q(a),c(a),$("#modalBtnClose").click()):d(a)}).fail(function(){alert("Network Error"),location.reload()}).always(function(){$("#loader").hide()});break;case"#bitcoin":$("#loader").show(),$.ajax({type:"POST",beforeSend:function(){},url:p,dataType:"JSON",headers:{"Content-Type":"application/json","x-api-key":`${o}`,operation:"2",service:`${k}`},data:JSON.stringify({amount:b,currency:f,description:g,payer:m,ref:i})}).done(function(a){a.success?($.alert({title:lang.bitcoin.title,content:`${lang.bitcoin.content}. <br>
